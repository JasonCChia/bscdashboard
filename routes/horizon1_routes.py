...
@horizon1_bp.route('/horizon/1/objective_<string:objective_id>')
def view_objective(objective_id):
    ...
    if user_role == 'admin' or (user_role == 'user' and user_horizon == 1):
...
# ============================
@horizon1_bp.route('/horizon/1/add_initiative', methods=['GET', 'POST'])
def add_initiative():
    if 'user_id' not in session:
        flash('Please log in first.', 'warning')
        return redirect(url_for('auth.login'))
...
@horizon1_bp.route('/horizon/1/edit_initiative/<int:initiative_id>', methods=['GET', 'POST'])
...
@horizon1_bp.route('/horizon/1/delete_initiative/<int:initiative_id>', methods=['POST'])
...
# ============================
@horizon1_bp.route('/horizon/1/add_measurement', methods=['GET', 'POST'])
def add_measurement():
    if 'user_id' not in session:
        flash('Please log in first.', 'warning')
        return redirect(url_for('auth.login'))
...
@horizon1_bp.route('/horizon/1/edit_measurement/<int:measurement_id>', methods=['GET', 'POST'])
...
@horizon1_bp.route('/horizon/1/delete_measurement/<int:measurement_id>', methods=['POST'])
...
# ================================
@horizon1_bp.route('/horizon/1/add_objective_note', methods=['GET', 'POST'])
...
@horizon1_bp.route('/horizon/1/delete_objective_note/<int:note_id>', methods=['POST'])
